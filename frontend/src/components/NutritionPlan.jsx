...
const TIMING = {
  breakfast: {
    ...
    'complete protein':{ en:'Eggs for breakfast is one of the most nutritionist-approved choices — high satiety, steady energy, and all 9 essential amino acids in one go.', ru:'Яйца на завтрак — один из самых одобренных нутрициологами выборов: высокое насыщение, стабильная энергия, все 9 незаменимых аминокислот сразу.' },
    'probiotic':       { en:'Probiotics first thing in the morning reach your gut in better condition before stomach acid increases. Ideal start for gut health.', ru:'Пробиотики утром достигают кишечника в лучшем состоянии, пока кислотность желудка ещё низкая. Идеальное начало для кишечника.' },
    'healthy fat':     { en:'Healthy fat at breakfast improves absorption of fat-soluble vitamins and keeps you full longer — this is why nutritionists always pair eggs or oats with avocado.', ru:'Полезный жир на завтрак улучшает усвоение жирорастворимых витаминов и дольше насыщает — вот почему нутрициологи всегда сочетают яйца или овсянку с авокадо.' },
    'fruit':           { en:'Fruit in the morning is ideal — natural sugars are burned off throughout the active day and won\'t be stored as fat.', ru:'Фрукты утром идеальны — природный сахар сжигается в течение активного дня и не откладывается в жир.' },
    'antioxidant':     { en:'Berries or green tea in the morning start an anti-inflammatory process that protects your cells all day.', ru:'Ягоды или зелёный чай утром запускают противовоспалительный процесс, который защищает клетки весь день.' },
    'omega-3 protein': { en:'Salmon at breakfast is uncommon but excellent — omega-3 in the morning supports brain function, focus, and reduces morning cortisol.', ru:'Лосось на завтрак необычно, но отлично — омега-3 утром поддерживают работу мозга, концентрацию и снижают утренний кортизол.' },
    'legume protein':  { en:'Legumes at breakfast provide slow carbs + plant protein — blood sugar stays flat all morning, no energy peaks or crashes.', ru:'Бобовые на завтрак дают медленные углеводы + растительный белок — сахар остаётся ровным всё утро, без скачков.' },
  },
  lunch: {
    'omega-3 protein': { en:'Perfect for lunch — omega-3 from fish supports afternoon focus and energy, and reduces the post-lunch energy dip.', ru:'Идеально на обед — омега-3 из рыбы поддерживают послеобеденный фокус и снижают спад энергии.' },
    'legume protein':  { en:'Legumes at lunch are excellent — slow carbs + plant protein keep blood sugar steady all afternoon without the 3pm crash.', ru:'Бобовые на обед отлично — медленные углеводы + растительный белок держат сахар ровным весь день без спада в 15:00.' },
    'complex carb':    { en:'Good timing for carbs — at lunch your body has hours ahead to use that glucose for energy, not storage.', ru:'Хорошее время для углеводов — на обеде у тела есть часы впереди, чтобы использовать глюкозу как энергию, а не откладывать.' },
    'lean protein':    { en:'Chicken or turkey at lunch is a nutritionist\'s top pick — lean protein fuels the afternoon without heaviness, keeps cravings away until dinner.', ru:'Курица или индейка на обед — топовый выбор нутрициолога: нежирный белок питает послеполудень без тяжести, удерживает от тяги до ужина.' },
    'vegetable':       { en:'Vegetables at every lunch is the single most consistent habit of healthy people. Your gut microbiome feeds on this fiber for the next 6 hours.', ru:'Овощи на каждый обед — самая стабильная привычка здоровых людей. Микробиом питается этой клетчаткой следующие 6 часов.' },
    'healthy fat':     { en:'Healthy fat at lunch — from olive oil, avocado or nuts — unlocks fat-soluble vitamins in your salad and keeps you full until dinner.', ru:'Полезный жир на обеде — из оливкового масла, авокадо или орехов — раскрывает жирорастворимые витамины в салате и насыщает до ужина.' },
    'complete protein':{ en:'Eggs at lunch give you a complete protein reset — every essential amino acid in one go, supports afternoon muscle and focus.', ru:'Яйца на обед дают полный белковый сброс — все незаменимые аминокислоты за один раз, поддерживают мышцы и фокус после полудня.' },
  },
  dinner: {
    'lean protein':    { en:'Chicken breast at dinner is ideal — light, easy to digest overnight, and the amino acids go directly into muscle repair while you sleep. Pair with vegetables only, avoid heavy carbs.', ru:'Куриная грудка на ужин идеальна — лёгкая, легко переваривается ночью, аминокислоты идут прямо на восстановление мышц во сне. Сочетайте только с овощами, избегайте тяжёлых углеводов.' },
    'omega-3 protein': { en:'Salmon at dinner is excellent — omega-3 actively reduces inflammation overnight, improves sleep quality, and supports skin repair. Best paired with asparagus, broccoli or zucchini.', ru:'Лосось на ужин отлично — омега-3 активно снижают воспаление ночью, улучшают качество сна и поддерживают восстановление кожи. Лучше с спаржей, брокколи или кабачком.' },
    'vegetable':       { en:'Vegetables at dinner are perfect — very low calorie, high in fiber, and the gut microbiome does its best repair work overnight on plant fiber.', ru:'Овощи на ужин идеальны — мало калорий, много клетчатки, микробиом кишечника лучше всего восстанавливается ночью на растительной клетчатке.' },
    'calming':         { en:'Herbal tea in the evening is a nutritionist staple — relaxes intestinal muscles, lowers cortisol and clearly signals the body to wind down for sleep.', ru:'Травяной чай вечером — стандарт нутрициолога: расслабляет кишечник, снижает кортизол и чётко сигнализирует телу о завершении дня.' },
    'complete protein':{ en:'Eggs at dinner provide slow-digesting protein that keeps blood sugar stable through the night — better sleep, no night hunger.', ru:'Яйца на ужин дают медленно усваиваемый белок, стабилизирующий сахар всю ночь — лучший сон, никакого ночного голода.' },
    'legume protein':  { en:'Legumes at dinner — lentils, chickpeas — digest slowly and stabilise blood sugar overnight, preventing 3am hunger. Excellent plant protein for dinner.', ru:'Бобовые на ужин — чечевица, нут — перевариваются медленно и стабилизируют сахар ночью, предотвращая голод в 3 часа. Отличный растительный белок для ужина.' },
    'healthy fat':     { en:'A small amount of healthy fat at dinner — olive oil, avocado — helps absorb fat-soluble vitamins from your vegetables and supports hormone production overnight.', ru:'Небольшое количество полезного жира на ужине — оливковое масло, авокадо — помогает усвоить жирорастворимые витамины из овощей и поддерживает выработку гормонов ночью.' },
  },
  snack: {
    'nut':             { en:'Ideal snack — the combination of healthy fat + plant protein keeps blood sugar completely stable and hunger away for 2–3 hours without spiking insulin.', ru:'Идеальный перекус — комбинация полезного жира + растительного белка полностью стабилизирует сахар и удерживает голод 2–3 часа без скачка инсулина.' },
    'seed':            { en:'Seeds as a snack are nutrient-dense and low calorie — pumpkin seeds especially give you magnesium and zinc that most women are chronically short on.', ru:'Семена на перекус питательны и малокалорийны — особенно тыквенные: дают магний и цинк, которого большинству женщин хронически не хватает.' },
    'fruit':           { en:'Smart snack — natural fruit sugar gives a quick energy lift, fiber slows absorption so there\'s no crash. Best at 10:30am or 3–4pm.', ru:'Умный перекус — природный сахар даёт быстрый заряд, клетчатка замедляет усвоение — без спада. Лучше в 10:30 или 15:00–16:00.' },
    'probiotic':       { en:'Yogurt or kefir as a snack continuously feeds your gut microbiome between meals — this daily habit is one of the most impactful things you can do for gut health.', ru:'Йогурт или кефир на перекус непрерывно питает микробиом между приёмами пищи — эта ежедневная привычка — одно из самых эффективных действий для здоровья кишечника.' },
    'antioxidant':     { en:'Green tea as a snack is excellent — L-theanine provides calm focus without the cortisol spike of coffee, and polyphenols are anti-inflammatory.', ru:'Зелёный чай на перекус отлично — L-теанин даёт спокойный фокус без скачка кортизола от кофе, а полифенолы противовоспалительны.' },
    'healthy fat':     { en:'Small portion of healthy fat as a snack — avocado, a few nuts — keeps insulin low and energy stable. Nutritionists call this a "bridging snack".', ru:'Небольшая порция полезного жира на перекус — авокадо, несколько орехов — держит инсулин низким и энергию стабильной. Нутрициологи называют это "мостовым перекусом".' },
  },
};
...
const COMBOS = [
  // ── Great pairs ──────────────────────────────────────────────────────────────
  {
    ...
    partner: ['avocado','авокадо'],
    type: 'great',
    msg: { en:'Egg + avocado is one of the most nutritionally complete combos: egg protein covers all 9 essential amino acids, avocado fat unlocks vitamins A, D, E, K, and both support hormonal health. Ideal at breakfast or lunch.', ru:'Яйцо + авокадо — одна из самых питательно полных комбинаций: белок яйца покрывает все 9 незаменимых аминокислот, жир авокадо раскрывает витамины A, D, E, K, и оба поддерживают гормональное здоровье. Идеально на завтрак или обед.' },
  },
  {
    trigger: ['egg','eggs','яйцо','яйца'],
    partner: ['spinach','шпинат','broccoli','брокколи','arugula','руккола','carrot','морковь'],
    type: 'great',
    msg: { en:'Fat from eggs is the key that unlocks fat-soluble vitamins (A, K, E) hidden in your vegetables. Without fat, these vitamins pass through almost unused. Eggs + greens is textbook nutrition — great at any meal.', ru:'Жир яиц — ключ, раскрывающий жирорастворимые витамины (A, K, E) в овощах. Без жира они почти не усваиваются. Яйца + зелень — учебник нутрициологии. Хорошо в любой приём пищи.' },
  },
  {
    trigger: ['chicken','курица','грудка','turkey','индейка'],
    partner: ['broccoli','брокколи','cauliflower','цветная капуста','spinach','шпинат','asparagus','спаржа','zucchini','кабачок'],
    type: 'great',
    msg: { en:'Chicken breast + cruciferous vegetables is the most recommended dinner combination in sports and clinical nutrition. Light protein for overnight muscle repair + high-fiber vegetables for gut microbiome. No heavy carbs needed at dinner — this is enough.', ru:'Куриная грудка + крестоцветные овощи — самая рекомендованная ужин-комбинация в спортивной и клинической нутрициологии. Лёгкий белок для восстановления мышц ночью + клетчатка для микробиома. Тяжёлые углеводы на ужин не нужны — этого достаточно.' },
  },
  {
    trigger: ['chicken','курица','грудка','turkey','индейка'],
    partner: ['buckwheat','гречка','quinoa','киноа','sweet potato','батат','brown rice','бурый рис'],
    type: 'great',
    msg: { en:'Chicken + complex carb (buckwheat, quinoa, sweet potato) is the ideal lunch plate — lean protein keeps you full, complex carb gives steady energy for the whole afternoon. This is what a sports nutritionist puts on the lunch menu.', ru:'Курица + сложный углевод (гречка, киноа, батат) — идеальная обеденная тарелка: нежирный белок насыщает, сложный углевод даёт стабильную энергию на весь день. Именно это спортивный нутрициолог ставит в обеденное меню.' },
  },
  {
    trigger: ['salmon','лосось','fish','рыба','cod','треска','tuna','тунец'],
    partner: ['lemon','лимон','citrus','orange','апельсин','kiwi','киви'],
    type: 'great',
    msg: { en:'Lemon on fish isn\'t just flavour — vitamin C from citrus enhances non-heme iron absorption from fish and also protects the omega-3 fatty acids from oxidation. A squeeze of lemon on salmon is basic nutritionist practice.', ru:'Лимон к рыбе — не просто вкус: витамин C из цитруса усиливает усвоение железа из рыбы и защищает жирные кислоты омега-3 от окисления. Несколько капель лимона на лосось — базовая практика нутрициолога.' },
  },
  {
    trigger: ['salmon','лосось','fish','рыба','cod','треска','tuna','тунец'],
    partner: ['olive oil','оливковое масло','avocado','авокадо'],
    type: 'great',
    msg: { en:'Healthy fat alongside fish multiplies omega-3 absorption — your body absorbs up to 3× more with fat present. Salmon + avocado or olive oil is a clinical nutrition pairing, especially powerful at dinner when the body repairs overnight.', ru:'Полезный жир рядом с рыбой умножает усвоение омега-3 — тело усваивает до 3× больше при наличии жира. Лосось + авокадо или оливковое масло — клиническая пара в нутрициологии, особенно сильная на ужин.' },
  },
  {
    trigger: ['salmon','лосось'],
    partner: ['asparagus','спаржа','broccoli','брокколи','spinach','шпинат'],
    type: 'great',
    msg: { en:'Salmon + asparagus (or broccoli) is one of the most anti-inflammatory meal combinations possible — omega-3 from salmon and folate + sulforaphane from vegetables work together to lower systemic inflammation. Excellent at dinner.', ru:'Лосось + спаржа (или брокколи) — одна из самых противовоспалительных комбинаций: омега-3 из лосося и фолат + сульфорафан из овощей вместе снижают системное воспаление. Отлично на ужин.' },
  },
  {
    trigger: ['oat','oats','oatmeal','овсянка','овёс'],
    partner: ['berries','berry','ягоды','kiwi','киви','apple','яблоко'],
    type: 'great',
    msg: { en:'Oat beta-glucan + berry antioxidants is a classic nutritionist breakfast: beta-glucan lowers cholesterol, feeds gut bacteria, and the berry polyphenols amplify these effects. Better together than either alone.', ru:'Бета-глюкан овса + антиоксиданты ягод — классический завтрак нутрициолога: бета-глюкан снижает холестерин, кормит бактерии, а полифенолы ягод усиливают эти эффекты. Вместе лучше, чем по отдельности.' },
  },
  {
    trigger: ['oat','oats','oatmeal','овсянка','овёс'],
    partner: ['egg','eggs','яйцо','яйца','cottage cheese','творог','yogurt','йогурт','kefir','кефир'],
    type: 'great',
    msg: { en:'Oats alone are carbs — adding eggs, cottage cheese or yogurt turns this into a complete breakfast with protein. Blood sugar stays flat for 3–4 hours instead of spiking at 1 hour.', ru:'Овсянка сама по себе — только углеводы. Добавление яиц, творога или йогурта превращает её в полноценный завтрак с белком. Сахар остаётся ровным 3–4 часа вместо скачка через час.' },
  },
  {
    trigger: ['spinach','шпинат','broccoli','брокколи','lentil','lentils','чечевица','beef','говядина'],
    partner: ['lemon','лимон','citrus','orange','апельсин','kiwi','киви','tangerine','мандарин','bell pepper','перец болгарский','sweet pepper'],
    type: 'great',
    msg: { en:'Vitamin C from citrus or bell pepper increases non-heme iron absorption from greens and legumes by up to 3× — a fact every nutritionist knows. Spinach salad with lemon is one of the smartest simple choices you can make.', ru:'Витамин C из цитруса или болгарского перца увеличивает усвоение негемового железа из зелени и бобовых до 3× — это знает каждый нутрициолог. Салат из шпината с лимоном — один из умнейших простых выборов.' },
  },
  {
    trigger: ['buckwheat','гречка','quinoa','киноа','lentil','lentils','чечевица'],
    partner: ['chicken','курица','egg','eggs','яйцо','salmon','лосось','fish','рыба','beef','говядина'],
    type: 'great',
    msg: { en:'Complex carb + protein is the foundation of balanced nutrition: the carb gives you energy, the protein slows glucose absorption so blood sugar stays flat for 3–4 hours. This combination is the basis of every serious meal plan.', ru:'Сложный углевод + белок — основа сбалансированного питания: углевод даёт энергию, белок замедляет усвоение глюкозы, сахар остаётся стабильным 3–4 часа. Эта комбинация — основа каждого серьёзного плана питания.' },
  },
  {
    trigger: ['avocado','авокадо'],
    partner: ['spinach','шпинат','arugula','руккола','carrot','морковь','broccoli','брокколи','tomato','помидор'],
    type: 'great',
    msg: { en:'Avocado in a salad isn\'t a luxury — it\'s nutritional science. Fat from avocado unlocks vitamins A, K, and E from the vegetables. Without fat, you absorb nearly zero of these from raw greens. Always add healthy fat to your salad.', ru:'Авокадо в салате — не роскошь, это нутрициология. Жир из авокадо раскрывает витамины A, K и E из овощей. Без жира вы почти не усваиваете их из сырой зелени. Всегда добавляйте полезный жир в салат.' },
  },
  {
    trigger: ['yogurt','йогурт','kefir','кефир','cottage cheese','творог'],
    partner: ['berries','berry','ягоды','apple','яблоко','kiwi','киви'],
    type: 'great',
    msg: { en:'Probiotic dairy + fruit is one of the best gut health combinations: the probiotic bacteria in yogurt/kefir eat the fruit polyphenols and multiply. This daily habit — yogurt with berries — is consistently found in the diets of the healthiest women.', ru:'Пробиотическое молочное + фрукты — одна из лучших комбинаций для здоровья кишечника: бактерии в йогурте/кефире поглощают полифенолы фруктов и размножаются. Эта ежедневная привычка — йогурт с ягодами — стабильно встречается в питании самых здоровых женщин.' },
  },
  {
    trigger: ['beet','beets','свёкла','свекла'],
    partner: ['walnut','walnuts','грецкий орех','olive oil','оливковое масло','arugula','руккола'],
    type: 'great',
    msg: { en:'Beet + walnuts or olive oil is a nutritionist classic: the healthy fat unlocks fat-soluble antioxidants (betaine, betalain) in beet that are otherwise poorly absorbed. Add lemon for iron — this bowl covers everything.', ru:'Свёкла + грецкие орехи или оливковое масло — классика нутрициологии: полезный жир раскрывает жирорастворимые антиоксиданты свёклы (бетаин, беталаин), которые иначе плохо усваиваются. Добавьте лимон для железа — этот салат покрывает всё.' },
  },
  {
    trigger: ['lentil','lentils','чечевица'],
    partner: ['spinach','шпинат','carrot','морковь','tomato','помидор'],
    type: 'great',
    msg: { en:'Lentils + vegetables is an anti-inflammatory powerhouse: plant iron from lentils + vitamin C from tomato + fiber from carrot covers gut, blood, and energy in one dish. This is a dinner or lunch that nutritionists genuinely love.', ru:'Чечевица + овощи — противовоспалительная сила: железо из чечевицы + витамин C из помидора + клетчатка из моркови покрывают кишечник, кровь и энергию в одном блюде. Это ужин или обед, который нутрициологи искренне любят.' },
  },
  {
    trigger: ['egg','eggs','яйцо','яйца'],
    partner: ['tomato','помидор','sweet pepper','bell pepper','перец'],
    type: 'great',
    msg: { en:'Eggs + tomato or sweet pepper — vitamin C from the vegetables boosts iron absorption from the egg yolk and the fat in the egg unlocks lycopene from tomato. A simple classic combination with real science behind it.', ru:'Яйца + помидор или болгарский перец: витамин C из овощей усиливает усвоение железа из желтка, а жир яйца раскрывает ликопин из помидора. Простая классическая комбинация с реальной наукой за ней.' },
  },
  // ── Watch pairs ──────────────────────────────────────────────────────────────
  {
    trigger: ['coffee','кофе'],
    partner: ['egg','eggs','яйцо','beef','говядина','spinach','шпинат','lentil','lentils','чечевица','broccoli','брокколи','chicken','курица'],
    type: 'watch',
    msg: { en:'Coffee right after iron-rich food blocks up to 80% of iron absorption — tannins in coffee bind iron before it reaches the bloodstream. Wait at least 1 hour between your coffee and iron sources (meat, greens, legumes). Have coffee before or 1h after meals.', ru:'Кофе сразу после железосодержащих продуктов блокирует до 80% усвоения железа — танины кофе связывают железо до поступления в кровь. Ждите минимум 1 час между кофе и источниками железа. Пейте кофе до или через 1 ч. после еды.' },
  },
  {
    trigger: ['cheese','сыр','kefir','кефир','yogurt','йогурт'],
    partner: ['lentil','lentils','чечевица','spinach','шпинат','beef','говядина'],
    type: 'watch',
    msg: { en:'Dairy calcium and iron compete for the same absorption channels — eating them together can reduce iron uptake by 50–60%. Try to separate dairy products and iron-rich foods into different meals to get full benefit from both.', ru:'Кальций молочных продуктов и железо конкурируют за одни каналы всасывания — совместное употребление снижает усвоение железа на 50–60%. Старайтесь разделять молочное и железосодержащие продукты на разные приёмы пищи.' },
  },
  {
    trigger: ['chicken','курица','грудка','salmon','лосось','beef','говядина','egg','eggs','яйцо'],
    partner: ['bread','хлеб','pasta','макароны','potato','картофель','white rice','белый рис'],
    type: 'watch',
    msg: { en:'At dinner, protein + refined carbs (white bread, white potato, pasta) together spike insulin more than either alone and slow fat metabolism overnight. At dinner stick to protein + vegetables — save the complex carbs (buckwheat, quinoa, sweet potato) for lunch.', ru:'На ужине белок + рафинированные углеводы (белый хлеб, обычный картофель, паста) вместе сильнее повышают инсулин и замедляют жиросжигание ночью. На ужин — белок + овощи. Сложные углеводы (гречка, киноа, батат) оставьте на обед.' },
  },
  {
    trigger: ['fruit','apple','яблоко','orange','апельсин','tangerine','мандарин','berries','ягоды','banana','банан'],
    partner: ['chicken','курица','beef','говядина','salmon','лосось','egg','eggs','яйцо'],
    type: 'watch',
    msg: { en:'Fruit eaten right after a protein-heavy meal can cause bloating — fruit digests in 20–30 minutes but protein takes 2–4 hours. The fruit sits behind the protein and begins to ferment. Better to eat fruit 30 min before a meal, or as a standalone snack between meals.', ru:'Фрукты сразу после белкового приёма пищи могут вызвать вздутие — фрукты перевариваются за 20–30 мин, а белок — за 2–4 часа. Фрукты «застревают» за белком и начинают бродить. Лучше есть фрукты за 30 мин до еды или как самостоятельный перекус между приёмами.' },
  },
];
